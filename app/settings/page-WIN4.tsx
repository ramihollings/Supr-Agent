        ...
        <aside className="w-full md:w-64 flex-shrink-0 flex flex-col gap-2 border-r-0 md:border-r-4 border-primary pr-0 md:pr-8 mb-8 md:mb-0 sticky top-0 h-fit">
          ...
          <nav className="flex flex-col gap-2">
            ...
            <button 
              ...
              className="font-headline font-bold uppercase text-xs p-4 neo-border bg-tertiary text-on-tertiary hover:bg-primary hover:text-on-primary transition-all mt-4 flex items-center justify-center gap-2 shadow-[3px_3px_0px_0px_rgba(26,26,26,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none cursor-pointer"
            >
