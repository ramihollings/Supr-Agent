...
export function MissionWizard({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-primary/20 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="mission-wizard-title" className="bg-background neo-border neo-shadow-lg w-full max-w-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        <header className="p-6 border-b-4 border-primary flex justify-between items-center bg-primary text-on-primary">
          <div className="flex items-center gap-3">
            ...
            <h2 id="mission-wizard-title" className="font-headline text-2xl font-black uppercase tracking-tight">Project Builder</h2>
          </div>
          <button onClick={onClose} aria-label="Close project builder" className="hover:rotate-90 transition-transform">
           ...
           {step === 1 && (
             <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="space-y-2">
                  <label htmlFor="mission-name" className="font-headline font-bold uppercase text-sm tracking-widest text-primary">Project Name</label>
                  <input
                    id="mission-name"
                ...
                <div className="space-y-2">
                  <label htmlFor="mission-objective" className="font-headline font-bold uppercase text-sm tracking-widest text-primary">Core Objective</label>
                  <textarea
