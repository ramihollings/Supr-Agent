...
const navItems = [
  { href: '/', icon: 'dashboard', label: 'Workspace' },
  { href: '/mission-control', icon: 'insights', label: 'Glidepath' },
  { href: '/activity', icon: 'history', label: 'Activity' },
  { href: '/agents', icon: 'smart_toy', label: 'Agents' },
  { href: '/reasoning', icon: 'psychology', label: 'Reasoning' },
];

const bottomItems = [
  { href: '/code', icon: 'code', label: 'Code' },
  { href: '/research', icon: 'travel_explore', label: 'Research' },
  { href: '/mission-packet', icon: 'inventory_2', label: 'Mission Packet' },
